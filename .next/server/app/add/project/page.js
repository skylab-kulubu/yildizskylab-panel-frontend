...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_browser__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(next_dist_compiled_react_server_dom_webpack_server_browser__WEBPACK_IMPORTED_MODULE_7__);
    ...
    const tree = {
        ...
        {
        children: ['', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.t.bind(__webpack_require__, 6654, 23)), "C:\\Users\\emreu\\Documents\\GitHub\\yildizskylab-panel-frontend\\src\\app\\add\\project\\page.tsx"]}]
      },
        {
...
'head': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3311)), "C:\\Users\\emreu\\Documents\\GitHub\\yildizskylab-panel-frontend\\src\\app\\head.tsx"],
    ...
    const metadata = [{
          ...
          type: 'page',
          layer: 2,
          mod: () => Promise.resolve(/* import() eager */).then(__webpack_require__.t.bind(__webpack_require__, 6654, 23)),
          path: "C:\\Users\\emreu\\Documents\\GitHub\\yildizskylab-panel-frontend\\src\\app\\add\\project\\page.tsx",
        },];
    const pages = ["C:\\Users\\emreu\\Documents\\GitHub\\yildizskylab-panel-frontend\\src\\app\\add\\project\\page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7155))
...
module.exports = createProxy("C:\\Users\\emreu\\Documents\\GitHub\\yildizskylab-panel-frontend\\src\\app\\add\\project\\page.tsx");
...
/* harmony import */ var _utils_validations__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2210);
...
const Page = ()=>{
    ...
    const formik = (0,formik__WEBPACK_IMPORTED_MODULE_2__.useFormik)({
        ...
        validationSchema: _utils_validations__WEBPACK_IMPORTED_MODULE_3__/* .addProjectValidations */ .B,
        onSubmit: (values)=>{
            addProject(values.name, values.description, []);
            console.log(values);
        }
    });
    async function addProject(projectName, description, teams = []) {
        ...
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", {
          ...
          mb-16 bg-transparent border-b-2 text-base sm:text-md tracking-[0.1em] focus:outline-none block w-full sm:w-[30rem] px-2 sm:px-5 p-2  placeholder:tracking-[0.1em] placeholder-customLightPurple  focus:border-customAccent sm:hover:border-customAccent border-customLightPink ${formik.errors.name && formik.touched.name ? "border-red-500 focus:border-red-500" : "focus:border-[#27A68E] hover:border-[#27A68E] border-[#7C77B3]"}`
                ...
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("input", {
                    ...
                    onBlur: formik.handleBlur,
                    required: true,
                    placeholder: "Proje A\xe7ıklamasını Giriniz",
                    className: `font-inter mb-16 bg-transparent border-b-2 text-base sm:text-md tracking-[0.1em] focus:outline-none block w-full sm:w-[30rem] px-2 sm:px-5 p-2  placeholder:tracking-[0.1em] placeholder-customLightPurple  focus:border-customAccent sm:hover:border-customAccent border-customLightPink ${formik.errors.description && formik.touched.description ? "border-red-500 focus:border-red-500" : "focus:border-[#27A68E] hover:border-[#27A68E] border-[#7C77B3]"}`
                }),
...
var __webpack_exports__ = __webpack_require__.X(0, [463,952,135,322,210], () => (__webpack_exec__(8170)));
